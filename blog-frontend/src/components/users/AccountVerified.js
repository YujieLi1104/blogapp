...
import { verifyAccount } from '../../redux/slices/accountVerification/accVerifySlice';
...
export default function AccountVerified() {
  ...
  // store
  const acc = useSelector((state) => state.accountVerification);
  const { status, appErr, serverErr, isVerified, verified } = acc;
