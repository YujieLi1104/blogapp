...
const Login = () => {
  ...
  return (
    <>
      <section className='min-h-screen relative py-20 2xl:py-40 bg-gray-800 overflow-hidden'>
        <div className='absolute top-0 left-0 lg:bottom-0 h-full lg:h-auto w-full lg:w-4/12  bg-gray-800 lg:overflow-hidden'>
          <img
